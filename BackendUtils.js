...
class Database {
  constructor() {
    this.mongoUri = "mongoUri=mongodb://nxz9fela:nxz9@ac-fk89hmp-shard-00-00.jxhj7v6.mongodb.net:27017,ac-fk89hmp-shard-00-01.jxhj7v6.mongodb.net:27017,ac-fk89hmp-shard-00-02.jxhj7v6.mongodb.net:27017/?ssl=true&replicaSet=atlas-10icqw-shard-0&authSource=admin&appName=Backendnxz9";
    this.dbName = 'nxz9';
    this.client = null;
    this.db = null;
    this.collections = {
  ...
  async connect() {
    this.client = new MongoClient("mongoUri=mongodb://nxz9fela:nxz9@ac-fk89hmp-shard-00-00.jxhj7v6.mongodb.net:27017,ac-fk89hmp-shard-00-01.jxhj7v6.mongodb.net:27017,ac-fk89hmp-shard-00-02.jxhj7v6.mongodb.net:27017/?ssl=true&replicaSet=atlas-10icqw-shard-0&authSource=admin&appName=Backendnxz9");
  ...
  static tournaments = [
    {
      ...
      nameKey: "(.gg/sginfiniy) S4 - 1v1 Block Dash (Only Punch)",
      descriptionKey: "Practice your skills in the Stumble Infiniy TournamentX! mode!",
    ...
    },
    {
      ...
      startTime: new Date(),
      endTime: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000),
      nameKey: "(.gg/sginfiniy) S4 - 1v1 Block Dash Legendary (Only Punch)",
      descriptionKey: "Practice your skills in the Stumble Infiniy TournamentX! mode!",
